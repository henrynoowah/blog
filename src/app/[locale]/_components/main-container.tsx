...
import { IconBlockquote, IconBrandGithub, IconMessageCircle, IconUserBitcoin } from '@tabler/icons-react'
...
const MainContainer = () => {
  ...
  return (
    <BackgroundGradientAnimation className="pointer-events-auto">
        ...
        <div className={`fixed flex gap-2 justify-end z-30 pointer-events-auto top-4 end-4`}>
          <ThemeToggle />
          <LocaleToggle />
        </div>
